...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    // In window scroll mode, we look in the entire document for our stack cards
    // but limit it to this scroller wrapper to avoid selecting cards from other sections
    const queryContainer = useWindowScroll ? document : (scroller || document);
    const cards = Array.from(
      queryContainer.querySelectorAll('.scroll-stack-card')
    ) as HTMLElement[];
    ...
    // Call after short timeouts in case other components shifted page layout on load
